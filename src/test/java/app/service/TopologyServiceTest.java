...
public class TopologyServiceTest {
    ...
    public void shouldReturnRootNode(){
        ...
        DeviceNode actualResult = topologyService.getRootNode("root",nodeList);
    ...
    public void shouldReturnChildrenNodes(){
        DeviceNode rootNode = createRootNode();
        List<DeviceNode> actualResult = topologyService.getChildrenNodes(rootNode, Arrays.asList(createNode(),createNode(),createUnrelatedNode()));
    ...
    public void shouldPopulateNodes(){
        List<DeviceNode> actualResult = topologyService.getPopulatedNodes(Arrays.asList(createNode(),createNode(),createRootNode(),createUnrelatedNode()));
