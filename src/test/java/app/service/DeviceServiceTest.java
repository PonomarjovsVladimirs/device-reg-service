...
public class DeviceServiceTest {
    ...
    public void shouldInvokeCorrectMethods(){
        ...
        doReturn(topologyNodes).when(spy).gatherTopology(null);
        doReturn(eachDeviceNodes).when(spy).findEachDevice();
        doReturn(oneDeviceNodes).when(spy).findDevice(macAddress);
        doReturn(oneDeviceTopology).when(spy).gatherTopology(macAddress);

        List<DeviceNode> expectedTopology = spy.gatherDevices(null, true);
        List<DeviceNode> expectedEach = spy.gatherDevices(null, false);
        List<DeviceNode> expectedOneDevice = spy.gatherDevices(macAddress, false);
        List<DeviceNode> expectedOneDeviceTopology = spy.gatherDevices(macAddress,true);
    ...
    public void shouldReturnSingleDeviceNode(){
        ...
        List<DeviceNode> actual = deviceService.findDevice("macAddress");
    ...
    public void shouldReturnAllDevices(){
        ...
        List<DeviceNode> actual = deviceService.findEachDevice();
    ...
    public void shouldReturnAllRootAddresses(){
        ...
        List<String> actual = deviceService.findRootAddresses();
    ...
    public void shouldReturnFullTopology(){
        ...
        doReturn(rootNodeAddresses).when(spy).findRootAddresses();
        ...
        List<DeviceNode> actual = spy.gatherTopology(null);
    ...
    public void shouldReturnSingleDeviceTopology(){
        ...
        List<DeviceNode> actual = spy.gatherTopology(macAddress);
        Assert.assertEquals("actual result should be equal to expected" , populatedNodes, actual);
    }
}
